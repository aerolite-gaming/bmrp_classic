...
function SWEP:PrimaryAttack()
	...
	if FAdmin and trace.Entity:IsPlayer() and trace.Entity:GetPData("adminmode") == "1" then
        GAMEMODE:Notify(self.Owner, 1, 5, "You cannot arrest someone who has godmode.")
        return
	end
