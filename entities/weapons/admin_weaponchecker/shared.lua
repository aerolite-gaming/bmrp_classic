...
if CLIENT then
	SWEP.PrintName = "Admin Weapon Checker"
	SWEP.Slot = 1
	SWEP.SlotPos = 10
	SWEP.DrawAmmo = false
...
local NoStripWeapons = {"weapon_physgun", "weapon_physcannon", "keys", "gmod_camera", "gmod_tool", "weaponchecker", "admin_weaponchecker", "med_kit", "pocket"}
...
function SWEP:PrimaryAttack()
	...
	if not IsValid(trace.Entity) or not trace.Entity:IsPlayer() or trace.Entity:GetPos():Distance(self.Owner:GetPos()) > 1000 then
		return
	end
