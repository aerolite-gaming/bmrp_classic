...
local blacklist = {"weapon_", "npc_", "monster_", "spawned_weapon", "fadmin_jail", "drug_lab", "money_printer", "meteor", "microwave", "door", "func_", "player", "beam", "worldspawn", "env_", "path_", "spawned_shipment", "prop_physics"}
function SWEP:PrimaryAttack()
	...
	for k,v in pairs(blacklist) do
		if string.find(string.lower(trace.Entity:GetClass()), v) then
			GAMEMODE:Notify(self.Owner, 1, 4, "You can't put this in your pocket!")
			return
		end
	end
