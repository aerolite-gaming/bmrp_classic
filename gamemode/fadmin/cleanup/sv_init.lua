...
local function FreezeAllProps(ply, cmd, args)
	if not FAdmin.Access.PlayerHasPrivilege(ply, "CleanUp") then FAdmin.Messages.SendMessage(ply, 5, "No access!") return end
	...
	FAdmin.Messages.ActionMessage(ply, player.GetAll(), "You have frozen all props", "All props have been frozen", "has frozen all props")
end
...
FAdmin.StartHooks["CleanUp"] = function()
	...
	FAdmin.Commands.AddCommand("FreezeAllProps", FreezeAllProps)
