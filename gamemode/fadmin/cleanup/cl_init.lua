FAdmin.StartHooks["CleanUp"] = function()
	...
	FAdmin.Commands.AddCommand("FreezeAllProps", nil)
	...
	FAdmin.ScoreBoard.Server:AddServerAction("Freeze All Props", "FAdmin/icons/CleanUp", Color(155, 0, 0, 255), true, function(ply, button)
		RunConsoleCommand("_FAdmin", "FreezeAllProps")
	end)	
end