...
function FAdmin.ScoreBoard.Main.Show()
	...
	if IsValid(FAdmin.ScoreBoard.Player.Controls.AvatarBackgroundCrop) then
		FAdmin.ScoreBoard.Player.Controls.AvatarBackgroundCrop:Remove()
	end
	
	if IsValid(FAdmin.ScoreBoard.Player.Controls.AvatarBackground) then
		FAdmin.ScoreBoard.Player.Controls.AvatarBackground:Remove()
	end	
