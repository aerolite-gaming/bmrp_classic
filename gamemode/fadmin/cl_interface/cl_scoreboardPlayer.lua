...
function FAdmin.ScoreBoard.Player.Show(ply)
	...
	FAdmin.ScoreBoard.Player.Controls.AvatarBackgroundCrop = vgui.Create( "DPanel" )
	FAdmin.ScoreBoard.Player.Controls.AvatarBackgroundCrop:SetPos(FAdmin.ScoreBoard.X + 20, FAdmin.ScoreBoard.Y + 100)
