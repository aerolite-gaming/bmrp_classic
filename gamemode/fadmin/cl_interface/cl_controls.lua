...
function PANEL:Init()
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then self.lblHidden = vgui.Create("DLabel", self) end
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then self.lblHidden:SetMouseInputEnabled(false) end
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then self.lblHidden:SetColor(Color(255,255,255,200)) end
...
function PANEL:UpdatePlayerData()
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then 
		if self.Player:FAdmin_GetGlobal("FAdmin_hidescoreboard") then
			self.lblHidden:SetText("Hidden")
		else
...
function PANEL:ApplySchemeSettings()
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then self.lblHidden:SetFont("ScoreboardPlayerNameBig") end
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then self.lblHidden:SetFGColor(color_white) end
end
...
function PANEL:PerformLayout()
	...
	if FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "HideFromScoreboard") then self.lblHidden:SetPos(self:GetWide() -  350 * 1, 4) end
