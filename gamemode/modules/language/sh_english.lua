...
local english = {
	...
	npc_killpay = "%s for killing a loose specimen!",

	payday_message = "Payday! Banked %s!",
	payday_unemployed = "You received no money because your salary is 0",
	...
	keys_allowed_to_coown = "You are allowed to co-manage this\n(Press Reload with keys or press F2 to co-manage)\n",
	keys_other_allowed = "Allowed to co-manage:\n%s\n",
	keys_allow_ownership = "",
	keys_disallow_ownership = "(Press Reload with keys or press F2 to disallow ownership)",
	keys_owned_by = "Managed by: ",
	keys_cops_and_mayor = "All cops and the mayor",
	keys_unowned = "Available to Rent\n(Press Reload with keys or press F2 to rent)",
	...
	door_unown_arrested = "You can not rent or unrent things while arrested!",
	door_unownable = "This door cannot be rented or unrented!",
	door_sold = "You have sold this for %s",
	door_already_owned = "This door is already rented by someone!",
	door_cannot_afford = "You can not afford to rent this door!",
	...
	door_need_to_own = "You need to rent this door in order to be able to %s",
	door_rem_owners_unownable = "You can not remove owners if a door is non-rentable!",
	door_add_owners_unownable = "You can not add owners if a door is non-rentable!",
	rp_addowner_already_owns_door = "%s already owns (or is already allowed to rent) this door!",
	...
	yell = "yell",
	advert = "[Advert]",
	announcement = "[Facility Announcement]",
	radio = "radio",
	request = "(REQUEST!)",
	group = "(group)",
	...
	lockdown_started = "The Administrator has initiated a Lockdown, please evacuate the facility!",
	...
	set_custom_job = " Customise your job title (press enter to activate)",
